package ru.mirea.astaevka.yandexdriver;
...
import ru.mirea.astaevka.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {

    private ActivityMainBinding binding;
    private MapView mapView;
    private final Point ROUTE_START_LOCATION = new Point(55.793969, 37.701742);
    private final Point ROUTE_END_LOCATION = new Point(55.654817, 37.846125);
...
// Ининциализируем объект для создания маршрута водителя
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"Мега Белая Дача",
